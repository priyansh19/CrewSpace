...
export async function doctor(opts: {
  ...
  p.intro(pc.bgCyan(pc.black(" crewspace doctor ")));
  ...
  try {
    ...
    const readResult: CheckResult = {
      ...
      canRepair: false,
      repairHint: "Run `crewspaceai configure --section database` or `crewspaceai onboard`",
    };
...
async function runRepairableCheck(input: {
  ...
  loadCrewSpaceEnvFile(input.configPath);
