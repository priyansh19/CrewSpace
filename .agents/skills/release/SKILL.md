...
name: release
description: >
  Coordinate a full CrewSpace release across engineering verification, npm,
...
Run the full CrewSpace maintainer release workflow, not just an npm publish.
...
7. If running through CrewSpace, you have issue context for status updates and follow-up task creation.
...
CrewSpace now uses a commit-driven release model:
...
npm view crewspace@canary version
```
...
- release summary in CrewSpace issue context
