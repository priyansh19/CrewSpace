...
This is intentionally separate from the normal CrewSpace dev image.
...
```sh
review-checkout-pr crewspace/crewspace 432
cd /work/checkouts/crewspace-crewspace/pr-432
```
...
## Preview the CrewSpace app from the PR
...
- CrewSpace's embedded PostgreSQL and local storage stay inside the container home volume via `CREWSPACE_HOME=/home/reviewer/.crewspace-review`.
