...
This document covers the GitHub and npm setup required for the current CrewSpace release model:
...
Do this for every public package that CrewSpace publishes.
...
3. add a trusted publisher for the GitHub repository `priyansh19/CrewSpace`
...
2. revoke any personal automation token that used to publish CrewSpace
