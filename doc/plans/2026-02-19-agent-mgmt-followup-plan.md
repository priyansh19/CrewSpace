...
- `skills/crewspace/SKILL.md` and `skills/crewspace/references/api-reference.md` do not currently require markdown formatting quality for status comments (links, structure, readable updates).
...
## 6.2 `skills/crewspace-create-agent/SKILL.md`
