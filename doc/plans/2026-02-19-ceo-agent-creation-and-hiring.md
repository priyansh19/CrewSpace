...
- installed adapter list for this CrewSpace instance
...
## 8. New Skill: `crewspace-create-agent`

Create new skill directory:

- `skills/crewspace-create-agent/SKILL.md`
...
Also update `skills/crewspace/SKILL.md` to reference this skill for hiring workflows.
...
- `crewspace-create-agent` skill + docs updates
