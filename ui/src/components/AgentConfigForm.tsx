...
// Canonical type lives in @crewspaceai/adapter-utils; re-exported here
// so existing imports from this file keep working.
export type { CreateConfigValues } from "@crewspaceai/adapter-utils";
          ...
          <div className={cn(cards ? "border border-border rounded-lg p-4 space-y-3" : "px-4 pb-3 space-y-3")}>
            ...
            {isLocal && !props.hidePromptTemplate && (
              <>
                ...
                <div className="rounded-md border border-border bg-accent px-3 py-2 text-xs text-muted-foreground">
  ...
  return (
    <div className="space-y-1.5">
      ...
      <p className="text-[11px] text-muted-foreground/60">
        CREWSPACE_* variables are injected automatically at runtime.
      </p>
    </div>
  );
}
