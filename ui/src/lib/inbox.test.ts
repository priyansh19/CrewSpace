...
import type { Approval, DashboardSummary, HeartbeatRun, Issue, JoinRequest } from "@crewspaceai/shared";
import {
...
const dashboard: DashboardSummary = {
  ...
  costs: {
    ...
    tokensCumulative: { inputTokens: 0, outputTokens: 0, cachedInputTokens: 0 },
  },
  pendingApprovals: 1,
...
describe("inbox helpers", () => {
  ...
  it("maps legacy new-tab storage to mine", () => {
    localStorage.setItem("crewspace:inbox:last-tab", "new");
    expect(loadLastInboxTab()).toBe("mine");
  });
