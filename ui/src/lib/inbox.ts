...
export const DISMISSED_KEY = "crewspace:inbox:dismissed";
export const READ_ITEMS_KEY = "crewspace:inbox:read-items";
export const INBOX_LAST_TAB_KEY = "crewspace:inbox:last-tab";
