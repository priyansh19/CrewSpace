...
import { AGENT_ROLES } from "@crewspaceai/shared";
...
export function NewAgent() {
  ...
  const availableSkills = (companySkills ?? []).filter((skill) => !skill.key.startsWith("crewspaceai/crewspace/"));
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                Optional skills from the company library. Built-in CrewSpace runtime skills are added automatically.
              </p>
            </div>
