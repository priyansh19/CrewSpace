...
import { INBOX_MINE_ISSUE_STATUS_FILTER } from "@crewspaceai/shared";
...
import type { Approval, HeartbeatRun, Issue, JoinRequest } from "@crewspaceai/shared";
import {
    ...
    >
      ...
      {showResolutionButtons ? (
        <div className="mt-3 flex gap-2 sm:hidden">
          <Button
            size="sm"
            className="h-8 bg-success px-3 text-primary-foreground hover:bg-success/90"
            onClick={onApprove}
            disabled={isPending}
          >
            Approve
