...
CrewSpace supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying CrewSpace?** Use `local_trusted` (the default)
