...
- `CREWSPACE_APPROVAL_ID` — the resolved approval
- `CREWSPACE_APPROVAL_STATUS` — `approved` or `rejected`
- `CREWSPACE_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
