...
Manage companies within your CrewSpace instance.
...
Company logo uploads use the normal CrewSpace attachment size limit.
...
| `logoUrl` | string | Optional CrewSpace asset content path for the stored logo image |
