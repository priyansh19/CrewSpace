...
import { buildAgentMentionHref, buildProjectMentionHref } from "@crewspaceai/shared";
...
export const MarkdownEditor = forwardRef<MarkdownEditorRef, MarkdownEditorProps>(function MarkdownEditor({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative crewspace-mdxeditor-scope",
    ...
    >
      <MDXEditor
        ...
        onBlur={() => onBlur?.()}
        className={cn("crewspace-mdxeditor", !bordered && "crewspace-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "crewspace-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
              ...
              >
                {option.kind === "project" && option.projectId ? (
                  <span
                    ...
                    style={{ backgroundColor: option.projectColor ?? "#6c6a64" }}
                  />
                ) : (
                  <AgentIcon
