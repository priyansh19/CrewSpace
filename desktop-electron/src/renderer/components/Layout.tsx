...
const INSTANCE_SETTINGS_MEMORY_KEY = "crewspace.lastInstanceSettingsPath";

/** Pages that need full height with no padding — they manage their own layout */
function isFullPageRoute(pathname: string): boolean {
  return /\/(memory|agent-chat|office|terminal|workspace|blockers|taskboard|org|dashboard)$/.test(pathname);
}
...
export function Layout() {
  const { sidebarOpen, setSidebarOpen, toggleSidebar, leftNavOpen, setLeftNavOpen, toggleLeftNav, isMobile } = useSidebar();
