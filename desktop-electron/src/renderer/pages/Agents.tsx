...
import { AGENT_ROLE_LABELS, type Agent } from "@crewspaceai/shared";
...
function LiveRunIndicator({
  ...
  return (
    <Link
      ...
      className="flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-chart-2/10 hover:bg-chart-2/20 transition-colors no-underline"
