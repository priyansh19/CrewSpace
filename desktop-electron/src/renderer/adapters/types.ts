...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@crewspaceai/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@crewspaceai/adapter-utils").TranscriptEntry[];
