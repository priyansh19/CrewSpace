 ...
 *
 * This is placed on `globalThis.__crewspacePluginBridge__` and consumed by
...
declare global {
  ...
  var __crewspacePluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__crewspacePluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__crewspacePluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
