...
describe("shouldTrackDevServerPath", () => {
  it("ignores repo-local CrewSpace state and common test file paths", () => {
    expect(
      shouldTrackDevServerPath(
        ".crewspace/worktrees/PAP-712-for-project-configuration-get-rid-of-the-overview-tab-for-now/.agents/skills/crewspace",
      ),
    ).toBe(false);
