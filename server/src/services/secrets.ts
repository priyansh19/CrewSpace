...
import { companySecrets, companySecretVersions } from "@crewspaceai/db";
import type { AgentEnvConfig, EnvBinding, SecretProvider } from "@crewspaceai/shared";
import { envBindingSchema } from "@crewspaceai/shared";
