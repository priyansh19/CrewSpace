...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@crewspaceai/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: CrewSpacePluginManifestV1, pluginDbId?: string): void;
