 ...
 */
import type { CompanyPortabilityManifest } from "@crewspaceai/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [CrewSpace](https://crewspace.ing)");
  lines.push("");
