/**
 * PluginEventBus — typed in-process event bus for the CrewSpace plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@crewspaceai/shared";
import type { PluginEvent, EventFilter } from "@crewspaceai/plugin-sdk";
