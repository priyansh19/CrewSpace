...
import { companies, pluginLogs, pluginWebhookDeliveries } from "@crewspaceai/db";
import type {
  PluginStatus,
...
type PluginUiSlotDeclaration = NonNullable<NonNullable<CrewSpacePluginManifestV1["ui"]>["slots"]>[number];
/** Launcher declaration extracted from plugin manifest */
type PluginLauncherDeclaration = NonNullable<CrewSpacePluginManifestV1["launchers"]>[number];
...
interface PluginInstallRequest {
  /** npm package name (e.g., @crewspace/plugin-linear) or local path */
  packageName: string;
...
const BUNDLED_PLUGIN_EXAMPLES: AvailablePluginExample[] = [
  {
    packageName: "@crewspaceai/plugin-hello-world-example",
    pluginKey: "crewspace.hello-world-example",
    displayName: "Hello World Widget (Example)",
    description: "Reference UI plugin that adds a simple Hello World widget to the CrewSpace dashboard.",
    localPath: "packages/plugins/examples/plugin-hello-world-example",
    tag: "example",
  },
  {
    packageName: "@crewspaceai/plugin-file-browser-example",
    pluginKey: "crewspace-file-browser-example",
  ...
  {
    packageName: "@crewspaceai/plugin-kitchen-sink-example",
    pluginKey: "crewspace-kitchen-sink-example",
    displayName: "Kitchen Sink (Example)",
    description: "Reference plugin that demonstrates the current CrewSpace plugin API surface, bridge flows, UI extension surfaces, jobs, webhooks, tools, streams, and trusted local workspace/process demos.",
...
export function pluginRoutes(
   ...
   *   {
   *     "pluginId": "plg_123",
   *     "pluginKey": "crewspace.claude-usage",
