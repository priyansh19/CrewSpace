...
Eval framework for testing CrewSpace agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the CrewSpace heartbeat skill:
