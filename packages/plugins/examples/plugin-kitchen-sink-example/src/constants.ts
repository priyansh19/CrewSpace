import type { PluginLauncherRegistration } from "@crewspaceai/plugin-sdk";

export const PLUGIN_ID = "crewspace-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".crewspace-kitchen-sink-demo.txt",
} as const;
