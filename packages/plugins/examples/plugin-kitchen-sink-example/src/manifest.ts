...
const manifest: CrewSpacePluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current CrewSpace plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "CrewSpace",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the CrewSpace domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
