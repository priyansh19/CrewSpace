/**
 * Bundling presets for CrewSpace plugins.
 *
 ...
 * to match the CrewSpace plugin loader contract.
 */
export function createPluginBundlerPresets(input: PluginBundlerPresetInput = {}): PluginBundlerPresets {
  const uiExternal = [
    "@crewspaceai/plugin-sdk/ui",
    "@crewspaceai/plugin-sdk/ui/hooks",
    "react",
    "react-dom",
    "react/jsx-runtime",
  ];
  ...
  const rollupManifest: RollupLikeConfig = {
    ...
    external: ["@crewspaceai/plugin-sdk"],
  };
