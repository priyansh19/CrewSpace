...
import type { CrewSpacePlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@crewspaceai/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: CrewSpacePluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@crewspaceai/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
