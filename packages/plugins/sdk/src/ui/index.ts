/**
 * `@crewspaceai/plugin-sdk/ui` — CrewSpace plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@crewspaceai/plugin-sdk` (root).
 *
 ...
 * import { usePluginData, usePluginAction } from "@crewspaceai/plugin-sdk/ui";
 * import type { PluginWidgetProps } from "@crewspaceai/plugin-sdk/ui";
 *
