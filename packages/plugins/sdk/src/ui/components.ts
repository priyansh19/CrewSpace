 ...
 *
 * These components are exported from `@crewspaceai/plugin-sdk/ui` and are
 ...
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components In `@crewspaceai/plugin-sdk/ui`
 */
...
function createSdkUiComponent<TProps>(name: string): React.ComponentType<TProps> {
  return function CrewSpaceSdkUiComponent(props: TProps) {
