/**
 * `definePlugin` — the top-level helper for authoring a CrewSpace plugin.
 *
...
// ---------------------------------------------------------------------------
// CrewSpacePlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 */
export interface CrewSpacePlugin {
 ...
 * @returns A sealed `CrewSpacePlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@crewspaceai/plugin-sdk";
