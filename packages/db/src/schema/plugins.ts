...
import type { PluginCategory, PluginStatus, CrewSpacePluginManifestV1 } from "@crewspaceai/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<CrewSpacePluginManifestV1>().notNull(),
