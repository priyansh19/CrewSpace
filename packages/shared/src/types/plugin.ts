...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within CrewSpacePluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the CrewSpace host.
 *
...
export interface CrewSpacePluginManifestV1 {
   ...
   */
  minimumCrewSpaceVersion?: PluginMinimumHostVersion;
