...
export const databaseConfigSchema = z.object({
  ...
  embeddedPostgresDataDir: z.string().default("~/.crewspace/instances/default/db"),
...
export const loggingConfigSchema = z.object({
  ...
  logDir: z.string().default("~/.crewspace/instances/default/logs"),
});
...
export const storageLocalDiskConfigSchema = z.object({
  baseDir: z.string().default("~/.crewspace/instances/default/data/storage"),
});

export const storageS3ConfigSchema = z.object({
  bucket: z.string().min(1).default("crewspace"),
...
export const storageConfigSchema = z.object({
  ...
  localDisk: storageLocalDiskConfigSchema.default({
    baseDir: "~/.crewspace/instances/default/data/storage",
  }),
...
export const secretsLocalEncryptedConfigSchema = z.object({
  keyFilePath: z.string().default("~/.crewspace/instances/default/secrets/master.key"),
});
...
export const secretsConfigSchema = z.object({
  ...
  localEncrypted: secretsLocalEncryptedConfigSchema.default({
    keyFilePath: "~/.crewspace/instances/default/secrets/master.key",
  }),
});

export const crewspaceConfigSchema = z
  .object({
...
export type CrewSpaceConfig = z.infer<typeof crewspaceConfigSchema>;
